...
export class PostProcessing {
    constructor(renderer, scene, camera) {
        ...
        Object.defineProperty(this, "causticsPass", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        this.bloomPass = new UnrealBloomPass(new THREE.Vector2(window.innerWidth, window.innerHeight), 1.5, // strength
        0.4, // radius
        0.85 // threshold
        );
    ...
    update(deltaTime, lightPosition) {
        this.time += deltaTime;
        ...
        if (lightPosition) {
            ...
            this.causticsPass.uniforms.lightPosition.value.set((vector.x + 1) / 2, (vector.y + 1) / 2, vector.z);
        }
    }
    render() {
